...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse httpServletResponse, String refreshToken) {
        ...
        if(redisEmail != null) {
            Optional<AppMember> user = appMemberRepository.findByEmailAndDeletedDateIsNull(redisEmail);
     ...
     */
    public String reIssueRefreshToken(AppMember user) {
                ...
                .ifPresent(accessToken -> {
                    if (jwtService.isTokenValid(accessToken)) {
                        ...
                        jwtService.extractEmail(accessToken)
                                .ifPresent(email -> appMemberRepository.findByEmailAndDeletedDateIsNull(email)
